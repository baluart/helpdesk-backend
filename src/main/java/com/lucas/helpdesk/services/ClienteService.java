...
import com.lucas.helpdesk.services.exceptions.ObjectonotFoundException;
...
public class ClienteService {
	...
	public Cliente findById(Integer id) {
		...
		return obj.orElseThrow(()  -> new ObjectonotFoundException("Objeto não encontrado ID:" +id));
	}
	...
	public void delete(Integer id) {
		...
		if(obj.getChamados().size() > 0) {
			throw new DataIntegrityViolationException("burro o cara ainda tem um chamado pra fechar !!");
